...
public class CSVParser2 {
   ...
   *
   * @param file    読込み対象のファイル
   * @param charset 対象ファイルの文字コード
   */
   ...
   *
   * @param func １レコードに対する処理を自由に記述したメソッドを渡します。<br>
   *             レコードとしてStringの入ったArrayListが渡されます。<br>
   * @throws IOException コンストラクタで与えられたファイルが見つからない場合など。<br>
   */
